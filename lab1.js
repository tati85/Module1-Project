...
let extraSpecialBonus = "race car";
let newExtraSpecialBonus=extraSpecialBonus.split(" ").join();
newExtraSpecialBonus=newExtraSpecialBonus.split(",").join('').toUpperCase();
//console.log(newExtraSpecialBonus)
let newReverse=reverse(newExtraSpecialBonus);
//console.log(newReverse);

newReverse.localeCompare(newExtraSpecialBonus)===0?console.log("palindrome"):console.log("No palindrome");
